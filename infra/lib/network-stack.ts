 ...
 *          generated by CDK on first deploy). NOT rotated — wiring
 *          `addRotationSingleUser` lands with the hardening pass; for
 *          now the secret value is static after creation.
